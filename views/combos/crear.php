...
<head>
    ...
    <title>Nuevo Combo - Sistema Napanchita</title>
...
<body>
    ...
    <div class="header-section">
        <div class="container">
            <h1><i class="fas fa-plus-circle"></i> Nuevo Combo</h1>
            <p class="mb-0">Crea un combo con múltiples productos</p>
        </div>
    </div>
        ...
        <div class="row justify-content-center">
            <div class="col-md-10">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="<?php echo BASE_URL; ?>index.php?controller=combos&action=guardar"
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control" id="descripcion" name="descripcion"
                                    rows="3" placeholder="Descripción del combo"></textarea>
                            </div>
