...
CREATE TABLE mesas (
    ...
    posicion_x INT DEFAULT 0 COMMENT 'PosiciÃ³n X en layout visual',
    posicion_y INT DEFAULT 0 COMMENT 'PosiciÃ³n Y en layout visual',
    activo BOOLEAN DEFAULT TRUE,
...
CREATE TABLE pedidos (
    ...
    cliente_id INT,
    mesa_id INT,
    usuario_id INT NOT NULL COMMENT 'Usuario que registrÃ³ el pedido',
...
CREATE TABLE ventas (
    ...
    usuario_id INT NOT NULL COMMENT 'Cajero que registrÃ³',
...
-- ============================================
-- TABLA: LOGS (Opcional - para auditorÃ­a)
-- ============================================
...
('Bebidas', 'Bebidas frÃ­as y calientes', 5),
...
-- Chicharrones
(2, 'ChicharrÃ³n de Pescado', 'Pescado frito crujiente', 28.00, TRUE),
(2, 'ChicharrÃ³n de Calamar', 'Anillos de calamar fritos', 32.00, TRUE),
(2, 'ChicharrÃ³n Mixto', 'Mix de mariscos fritos', 35.00, TRUE),

-- Jalea
(3, 'Jalea Mixta Personal', 'PorciÃ³n individual', 30.00, TRUE),
...
-- Entradas
(6, 'Causa Rellena', 'Causa de pollo o atÃºn', 15.00, TRUE),
(6, 'Papa a la HuancaÃ­na', 'Papas con salsa huancaÃ­na', 12.00, TRUE),
(6, 'TequeÃ±os', 'TequeÃ±os de queso (6 unid.)', 18.00, TRUE),

-- Postres
(7, 'Suspiro LimeÃ±o', 'Postre tradicional', 12.00, TRUE),
...
('Tarjeta', 'Tarjeta de dÃ©bito o crÃ©dito'),
('Yape', 'Pago por Yape'),
('Plin', 'Pago por Plin'),
...
-- Procedimiento para generar cÃ³digo de confirmaciÃ³n Ãºnico
DELIMITER $$
...
-- Crear usuario para la aplicaciÃ³n (en producciÃ³n)
...
### Datos Iniciales:
- âœ… 3 usuarios del sistema
- âœ… 7 categorÃ­as
- âœ… 20 productos
- âœ… 3 combos
- âœ… 10 mesas
- âœ… 5 zonas de delivery
